...
class CustomizeProductDialog extends StatefulWidget {
  final int productId;
  final String name;
  final String nameAr;
  final String image;
  ...
  @override
  State<CustomizeProductDialog> createState() => _CustomizeProductDialogState();
}

class _CustomizeProductDialogState extends State<CustomizeProductDialog> {
  //*
